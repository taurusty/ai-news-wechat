...
class EngadgetSource(BaseSource):
    """Engadget - 抓取（后续通过AI关键词筛选）"""

    def __init__(self, weight: float = 0.9, enabled: bool = True):
        super().__init__(base_url="https://www.engadget.com/", source_name="engadget", weight=weight, enabled=enabled)

    async def fetch_articles(self, max_items: int = 10) -> List[Article]:
        list_url = "https://www.engadget.com/"
